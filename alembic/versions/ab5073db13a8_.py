...
def upgrade() -> None:
    ...
    sa.Column('payment_method', postgresql.ENUM('CASH', 'CARD', 'DIGITAL', name='paymentmethod', create_type=False), nullable=True),
   ...
   sa.Column('method', postgresql.ENUM('CASH', 'CARD', 'DIGITAL', name='paymentmethod', create_type=False), nullable=False),
