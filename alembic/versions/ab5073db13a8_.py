...
def upgrade() -> None:
    ...
    sa.Column('payment_method', sa.Enum('CASH', 'CARD', 'DIGITAL', name='paymentmethod', create_type=False), nullable=True),
   ...
   sa.Column('method', sa.Enum('CASH', 'CARD', 'DIGITAL', name='paymentmethod', create_type=False), nullable=False),
